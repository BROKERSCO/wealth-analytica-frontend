...
import { BarChart3, FolderOpen, FileText, LogOut, User, ChevronRight, Shield, TrendingUp, Wifi, Zap } from 'lucide-react'
import { cn } from '@/lib/utils'

const navItems = [
  { href: '/dashboard/novo-laudo',    label: 'Novo Laudo', icon: Zap },
  { href: '/dashboard/cases',         label: 'Casos',      icon: FolderOpen },
  { href: '/dashboard/laudos',        label: 'Laudos',  icon: FileText },
  { href: '/dashboard/analytics',     label: 'Analytics',    icon: TrendingUp },
  { href: '/dashboard/openfinance',   label: 'Open Finance', icon: Wifi },
